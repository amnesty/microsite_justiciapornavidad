...
if ( strpos ( $_SERVER['SERVER_NAME'], "amnistia.bit" )) { 
	define("URL_SITE",     "http://dev.amnistia.bit/navidad/"); // Servidor Local estrés
} elseif ( strpos ( $_SERVER['SERVER_NAME'], "estresarte.com" ) ) {
	define("URL_SITE",     "http://testing.estresarte.com/amnistia/navidad/"); // Producción estrés
} else {
...
define ("NUM_FIRMAS_TOTAL", "100000");
