...
if ( strpos ( $_SERVER['SERVER_NAME'], "amnistia.bit" )) {
	define("URL_SITE",     "http://dev.amnistia.bit/navidad2/"); // Servidor Local estrés
} elseif ( strpos ( $_SERVER['SERVER_NAME'], "estresarte.com" ) ) {
	define("URL_SITE",     "http://testing.estresarte.com/amnistia/navidad2/"); // Producción estrés
} else {
...
define ("NUM_FIRMAS_TOTAL", "180000");


//Trackeado de enlaces con UTM de Google Analytics
define ("TRACK_FB_UTM", "?utm_source=facebook&utm_campaign=comp&utm_medium=social_com&utm_term=Killings_disappearances&utm_content=Web_petition-justiciapornavidad-facebook");
