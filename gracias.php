                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                        ...
                        <div class="box-text-adorno">
                            <h5>Sigue colaborando con la campaña mientras decoras tu hogar esta Navidad.</h5>
                            <p>Al mismo tiempo que adornas tu Navidad con tus buenos deseos, colaboras para conseguir justicia.</p>
                            <a class="btn-consigue-adorno hvr-sweep-to-bottom" href="https://crm.es.amnesty.org/haz-un-donativo-por-navidad/?origen=justiciapornavidad" target="_blank">Consigue tu adorno</a>
                        </div><!-- /box-text-adorno -->
                        <img class="bola-desktop" src="images/bola-gracias.png" alt="Adorno">
                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 gracias-hazte-socio">
                        <div class="box-hazte-socio">
                            ...
                            <a class="btn-hazte-socio hvr-sweep-to-bottom" href="https://crm.es.amnesty.org/unete-a-amnistia-por-navidad/?origen=justiciapornavidad" target="_blank">Hazte socio/a</a>
                        </div>
                    </div>
                </div><!--.row-->
