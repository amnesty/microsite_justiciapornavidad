				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="youtubevideowrap">
                        <div class="video-container">
                            <iframe width="580" height="320" src="//www.youtube.com/embed/m7Kc0-JUW9U" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="rrss">
                        <ul class="clearfix">
                            <li><a  data-shareurl="<?php echo URL_SITE . 'antonio-narvaez' . TRACK_FB_UTM ; ?>" data-title="#JusticiaPorNavidad – Amnistía Internacional" data-texto="Personas como Antonio tienen familiares “desaparecidos” en fosas comunes. Todo lo que desean es que vuelva la Justicia. Firma y ayúdales a conseguirlo." data-imagen="<?php echo URL_SITE; ?>images/COMPARTIR-FB-CASO-ANTONIO.png" data-caption="justiciapornavidad.org" class="fa fa-facebook-official hvr-shrink facebook-share" href="#" title="Compartir en Facebook"></a></li>
                            ...
                            <li><a data-shareurl="<?php echo urlencode('https://goo.gl/2ZtG4n'); ?>" data-texto="Firma y ayuda a Antonio a hacer realidad un deseo que lleva muchos años sin cumplirse #JusticiaPorNavidad" class="fa fa-twitter hvr-shrink twitter-share" title="Compartir en Twitter" href="#"></a></li>
                            <?php
    if($isMobile) {
?>
                            <li><a class="fa fa-whatsapp hvr-shrink" title="Compartir en Whatsapp" data-href="<?php echo URL_SITE; ?>antonio-narvaez" data-action="share/whatsapp/share" href="whatsapp://send?text=<?=urlencode('#JusticiaPorNavidad – Amnistía Internacional https://goo.gl/1FCsOG')?>"></a></li>
<?php
}
?>
                        </ul>
