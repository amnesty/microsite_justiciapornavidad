...
<section id="firma" class="modulo-firma clearfix">
    <div class="container">
        <div class="box-text">
            <p><b>Miles de personas no volvieron a casa durante la guerra civil y el franquismo;</b> algunas durante días, otras no volvieron nunca.</p>
        </div>

        <div class="formulario-inicial">
            <div class="box-text">
                <p>En solidaridad con las víctimas, <b>firma para enviar <a class="enlace-peticion" href="#" data-toggle="modal" data-target="#modal-peticion">esta petición</a> al gobierno y que este año no se olvide de ellas.</b></p>
            </div>
            ...
            <form style="display: visible" id="formFirma" class="formulario-firma row" action="includes/enviar_form.php" method="post" onsubmit="return validarFormFirma(document.forms['formFirma']);">
                  ...
                  <div class="box-check">
                      <button id="btnEnviar" type="submit" class="btn btn-primary">Envía tu firma</button>
                      <button id="btnEnviando" type="button" class="btn btn-primary" style="display:none;">Enviando...</button>
