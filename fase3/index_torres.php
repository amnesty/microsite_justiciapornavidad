...
<head>
    ...
    <link rel="image_src" href="<?php echo URL_SITE; ?>fase3/images/compartir-tw-torres.png" />
    ...
    <meta property="og:image" content="<?php echo URL_SITE; ?>fase3/images/compartir-fb-torres.png" />
    ...
    <meta name="twitter:image" content="<?php echo URL_SITE; ?>fase3/images/compartir-tw-torres.png" />
...
<body>
	...
	<section class="modulo-home clearfix">
		...
		<div class="container">
            <div class="row">
                <div class="image-dest col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <img src="<?php echo URL_SITE; ?>fase3/images/foto.png" alt=""/>
                </div>
