		...
		<div class="container">
            <div class="row">
                ...
                <div class="text col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="box-text">
		            <p>&nbsp; </p>
		            <p>Hemos salido a la calle para recordar que <b>se cumplen 40 años de la aprobación de la Ley de Amnistía</b>, una ley que se utiliza para proteger a personas responsables de haber cometido graves violaciones de derechos humanos durante la guerra civil y el franquismo.</p>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    <div class="youtubevideowrap">
                        <div class="video-container">
                            <iframe width="580" height="320" src="//www.youtube.com/embed/rNufIC9b8Wk?rel=0" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
