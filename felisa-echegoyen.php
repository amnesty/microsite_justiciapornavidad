				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="youtubevideowrap">
                        <div class="video-container">
                            <iframe width="580" height="320" src="//www.youtube.com/embed/Nef_CC4XbVQ" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="rrss">
                        <ul class="clearfix">
                            <li><a  data-shareurl="<?php echo URL_SITE . 'felisa-echegoyen' . TRACK_FB_UTM ; ?>" data-title="#JusticiaPorNavidad – Amnistía Internacional" data-texto="Personas como Felisa 'desaparecieron' durante días para ser torturadas. Todo lo que desean es que vuelva la Justicia. Firma y ayúdales a conseguirlo." data-imagen="<?php echo URL_SITE; ?>images/COMPARTIR-FB-CASO-FELISA.png" data-caption="justiciapornavidad.org" class="fa fa-facebook-official hvr-shrink facebook-share" href="#" title="Compartir en Facebook"></a></li>
                            ...
                            <li><a data-shareurl="<?php echo urlencode('https://goo.gl/8gkYvK'); ?>" data-texto="Firma y ayuda a Felisa a hacer realidad un deseo que lleva muchos años sin cumplirse #JusticiaPorNavidad" class="fa fa-twitter hvr-shrink twitter-share" title="Compartir en Twitter" href="#"></a></li>
                            <?php
    if($isMobile) {
?>
                            <li><a class="fa fa-whatsapp hvr-shrink" title="Compartir en Whatsapp" data-href="<?php echo URL_SITE; ?>felisa-echegoyen" data-action="share/whatsapp/share" href="whatsapp://send?text=<?=urlencode('#JusticiaPorNavidad – Amnistía Internacional https://goo.gl/2Ieuix')?>"></a></li>
<?php
}
?>
                        </ul>
